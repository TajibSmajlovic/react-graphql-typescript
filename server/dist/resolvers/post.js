...
const paginatedResponse_1 = __importDefault(require("../utils/paginatedResponse"));
...
let PaginatedPostsResponse = class PaginatedPostsResponse extends paginatedResponse_1.default(Post_1.Post) {
};
PaginatedPostsResponse = __decorate([
...
__decorate([
    type_graphql_1.Query(() => PaginatedPostsResponse),
